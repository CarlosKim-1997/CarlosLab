                ...
                >
                  ...
                  {points.map((entry) => {
                    ...
                    return (
                      <span
                        key={entry.id}
                        className="absolute top-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-[#0b1019] shadow-[0_0_0_1px_rgba(255,255,255,0.12)]"
                        style={{
                          left: left + "%",
